            ...
            layout {
                ...
                HStack(spacing: isFold ? 8 : 12) {
                    ...
                    Text(isFold || self.viewModel.state.isTapping ? "탭" : "빠르기\n찾기")
                        .font(!isFold && self.viewModel.state.isTapping ? .pretendardRegular(size: 28) : .pretendardRegular(size: 17))
